...
class LegalPageRepository implements LegalPageRepositoryInterface
{
    public function __construct(
        ...
        private readonly \AlpineCommerce\LegalPages\Api\Data\LegalPageSearchResultsInterfaceFactory $searchResultsFactory
    ) {
    }
    ...
    {
        /** @var \AlpineCommerce\LegalPages\Model\ResourceModel\LegalPage\Collection $collection */

...
{
    public function __construct(Context $context, private readonly PageFactory $resultPageFactory, private readonly ProductLabelRepositoryInterface $labelRepository) { parent::__construct($context); }
    ...
    public function execute(): \Magento\Framework\Controller\ResultInterface
    {
        ...
        if ($labelId) {
            try {
                ...
                $this->_coreRegistry->register("productlabels_label", $label);
    ...
    protected function _isAllowed(): bool { return $this->_authorization->isAllowed("AlpineCommerce_ProductLabels::labels_save"); }
}

...
namespace AlpineCommerce\LoyaltyProgram\Model\Total\Quote;
...
{
    public const TOTAL_CODE = 'alpinecommerce_loyalty_discount';

    public const QUOTE_FIELD_POINTS_USED = 'alpinecommerce_loyalty_points_used';

...
namespace Cartware\Hreflang\Block;
...
/**
 * Renders hreflang alternate links for all store views.
 */
class Hreflang extends Template
{
    public const XML_PATH_ENABLED = 'cartware_hreflang/general/enabled';
    public const XML_PATH_X_DEFAULT = 'cartware_hreflang/general/x_default';
    ...
    /**
     * Relative path of the current request against the current store base URL.
     *
     * @return string
     */

...
namespace Cartware\EuVat\Console\Command;

use Cartware\EuVat\Api\VatValidationInterface;
...
class ValidateVatCommand extends Command
{
    ...
    {
        $this->setName('cartware:euvat:validate')
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $output->writeln('Country: ' . $result->getCountryCode());

...
class BlogCategoryRepository implements BlogCategoryRepositoryInterface
{
    public function __construct(
        ...
        private readonly \Cartware\Blog\Api\Data\BlogCategorySearchResultsInterfaceFactory $searchResultsFactory
    ) {
    }
    ...
    {
        /** @var \Cartware\Blog\Model\ResourceModel\BlogCategory\Collection $collection */

...
namespace Cartware\LoyaltyProgram\Observer;

use Cartware\LoyaltyProgram\Api\LoyaltyBalanceRepositoryInterface;
use Cartware\LoyaltyProgram\Helper\Points;
use Cartware\LoyaltyProgram\Logger\Logger;
use Cartware\LoyaltyProgram\Model\LoyaltyOrderPointsFactory;
use Cartware\LoyaltyProgram\Model\ResourceModel\LoyaltyOrderPoints\CollectionFactory;
...
class AwardPointsOnInvoice implements ObserverInterface
{
     ...
     *
     * The cartware_loyalty_order_points ledger (type=earn) makes this idempotent:

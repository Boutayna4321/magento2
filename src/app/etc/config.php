...
return [
    'modules' => [
        ...
        'AlpineCommerce_AutoInvoice' => 1,
        'AlpineCommerce_Blog' => 1,
        'AlpineCommerce_CreditMemo' => 1,
        ...
        'AlpineCommerce_PartialInvoice' => 1,
        'AlpineCommerce_ProductLabels' => 1,
        'AlpineCommerce_ProductQuestions' => 1,
        'AlpineCommerce_ProductReviews' => 1,
        'AlpineCommerce_Rma' => 1,
        'AlpineCommerce_StorePickup' => 1,
        'AlpineCommerce_StoreLocator' => 1,
        'AlpineCommerce_StoreSetup' => 1,
        'Hyva_Theme' => 1,

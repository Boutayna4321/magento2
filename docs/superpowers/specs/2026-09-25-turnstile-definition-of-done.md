...
- **Date :** 2026-09-25
- **Statut :** validé par l'utilisateur le 2026-09-25, puis mis à jour avec D3 = A, D4 = B (REST, SOAP, GraphQL), la correction S14/S15 (AJAX), la reformulation de S12, S27c (async / bulk, confirmée par test réel le 2026-09-25), D6 = 1 + a, D7 = 1, K10 reformulé et les ajouts R1 (ConstructorDependencyTest, P17, P18) — aucune implémentation n'est lancée
